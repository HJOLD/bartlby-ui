        ...
        function _globExt($svcid, $path) {
        	  ...
        	  $r = "<script language='JavaScript'>
        	  	...
        	  	function updatePerfhandlerExt(cnt) {
        	  		as = document.getElementById('SMSHide');
                ...
                $r = "<div id=SMSHide style='display:none'><font color='red'><img src='extensions/SMS/ajax-loader.gif'> reload in progress....</font></div><script>var maxExt = " . $x . ";</script><a href='javascript:updatePerfhandlerExt();'>Update Perfhandler data</A><br>" . $r;
                return $r;
        }
